...
const styles = StyleSheet.create({
  ...
  liftMainRow: { alignItems: "center", flexDirection: "row", width: "100%" },
  liftIconBox: { alignItems: "center", backgroundColor: "#0B0B0D", borderRadius: 16, flexShrink: 0, height: 58, justifyContent: "center", width: 58 },
  ...
  liftCopy: { flex: 1, flexShrink: 1, marginHorizontal: 12, minWidth: 0 },
  ...
  readyBadge: { backgroundColor: "rgba(52, 199, 89, 0.14)", borderRadius: 999, flexShrink: 0, paddingHorizontal: 9, paddingVertical: 6 },
  readyBadgeText: { color: READY, fontSize: 8, fontWeight: "900", letterSpacing: 0.5 },
  inputShell: { alignItems: "center", backgroundColor: "#0B0B0D", borderRadius: 13, flexDirection: "row", flexShrink: 0, paddingHorizontal: 10, width: 88 },
  weightInput: { color: "#FFFFFF", flexShrink: 1, fontFamily: Platform.select({ web: "inherit" }), fontSize: 18, paddingVertical: 10, textAlign: "right", width: 45 },
  ...
  reviewValueBox: { alignItems: "center", backgroundColor: "#0B0B0D", borderRadius: 13, flexShrink: 0, justifyContent: "center", minHeight: 44, paddingHorizontal: 10, width: 88 },
