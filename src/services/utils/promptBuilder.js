...
- Every exercise with "strengthAssessment" is top-set-only: set "sets" to "1 top set", work up to that top set, and stop. Do not include back-off sets, follow-up working sets, or "percentagePrescription" on the assessment exercise.
